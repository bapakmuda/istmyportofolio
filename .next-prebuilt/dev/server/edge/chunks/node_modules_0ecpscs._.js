(globalThis["TURBOPACK"] || (globalThis["TURBOPACK"] = [])).push(["chunks/node_modules_0ecpscs._.js",
...
async function getToken(params) {
    ...
    const { req, secureCookie = (_process$env$NEXTAUTH = (_process$env$NEXTAUTH2 = ("TURBOPACK compile-time value", "https://dadoftwo.web.id")) === null || _process$env$NEXTAUTH2 === void 0 ? void 0 : _process$env$NEXTAUTH2.startsWith("https://")) !== null && _process$env$NEXTAUTH !== void 0 ? _process$env$NEXTAUTH : !!process.env.VERCEL, cookieName = secureCookie ? "__Secure-next-auth.session-token" : "next-auth.session-token", raw, decode: _decode = decode, logger = console, secret = (_process$env$NEXTAUTH3 = ("TURBOPACK compile-time value", "firdyawan_super_secret_key_12345!")) !== null && _process$env$NEXTAUTH3 !== void 0 ? _process$env$NEXTAUTH3 : process.env.AUTH_SECRET } = params;
...
async function handleMiddleware(req, options, onSuccess) {
    ...
    const authPath = (0, _parseUrl.default)(("TURBOPACK compile-time value", "https://dadoftwo.web.id")).path;
    const publicPaths = [
        "/_next",
        "/favicon.ico"
    ];
    ...
    const secret = (_ref = (_options$secret = options === null || options === void 0 ? void 0 : options.secret) !== null && _options$secret !== void 0 ? _options$secret : ("TURBOPACK compile-time value", "firdyawan_super_secret_key_12345!")) !== null && _ref !== void 0 ? _ref : process.env.AUTH_SECRET;
    if (!secret) {
...
//# sourceMappingURL=node_modules_0ecpscs._.js.map